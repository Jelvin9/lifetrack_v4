...
<div class="content-wrapper flex justify-center items-center min-h-screen bg-gray-900">
    <div class="bg-gray-800 rounded-lg p-8 w-full md:w-2/3 lg:w-1/2 shadow-lg">
        <h2 class="text-2xl font-bold mb-6 text-white text-center">Add Event</h2>
        ...
        <!-- Form -->
        <form method="post" action="{{ route('events.store') }}" id="insertFormApparel" enctype="multipart/form-data">
            @csrf

                    <!-- Radio Buttons for Category -->
                    <div class="mb-6 text-center">
                        <div class="flex justify-center space-x-4">
                            <input type="radio" id="Indoor" name="type" value="Indoor" class="hidden">
                            <label for="Indoor" class="px-4 py-2 bg-gray-700 text-white border-4 rounded-full cursor-pointer border-transparent hover:border-indigo-700">
                                Indoor
                            </label>
                            <input type="radio" id="Outdoor" name="type" value="Outdoor" class="hidden">
                            <label for="Outdoor" class="px-4 py-2 bg-gray-700 text-white border-4 rounded-full cursor-pointer border-transparent hover:border-indigo-700">
                                Outdoor
                            </label>
                        </div>
                    </div>
